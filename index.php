...
<h2> Settings: </h2>
    <p> <strong> Distance: </strong> Only chairs at this distance from the empty chair can be swapped</p>
...
<h2> Rules: </h2>
    ...
    <p> - The scrambler can only swap chairs that are at the set distance from the empty chair</p>
    ...
    <p> - The arranger can only swap chairs that are at the set distance from the empty chair</p>
